      ...
      <div class="row">
          <div class="col-md-6 offset-md-3">
              <div class="signup-form">
                  <form action="register.php" method="POST" class="mt-5 border p-4 bg-light shadow needs-validated">
                  ...
                  <p class="text-center mt-3 text-secondary">Sudah memiliki akun? <a href="/masuk"> Masuk</a></p>
              </div>
          </div>
      </div>
  </div>
