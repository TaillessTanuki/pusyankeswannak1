                ...
                <ul class="nav nav-pills flex-column mb-auto">
                  ...
                  <li>
                    <a href="#" class="nav-link active" aria-current="page">
                      <svg class="bi me-2" width="16" height="16"><use xlink:href="#cetak-laporan" /></svg>
                      Cetak Laporan
                    </a>
                  </li>
                  <li class="nav-item dropdown">
              ...
              <div class="col-12">
                ...
                <div class="mb-4">
                  <select class="form-select" required aria-label="select example">
                    ...
                    <option value="1">Data Pelamar Keseluruhan</option>
                    <option value="2">Data Pelamar Tahap 1</option>
                    <option value="2">Data Pelamar Tahap 2</option>
                    <option value="2">Data Pelamar Tahap 3</option>
                  </select>
